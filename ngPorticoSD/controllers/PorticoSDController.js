(function () {
    ...
    function PorticoSDController($scope, $routeParams, ngPorticoSDTemplatePath, StageHelper, LevelService, AssetMapService) {
        ...
        $scope.templatePaths = ngPorticoSDTemplatePath;
